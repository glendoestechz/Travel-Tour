...
<head>
    ...
    <title>Puerto Galera Packages</title>
    <style>
        body {
    ...
    <main class="main-content">
        ...
        <div class="packages-grid">
            ...
            <div class="package-card">
                <img class="package-image" src="https://images.unsplash.com/photo-1464983953574-0892a716854b?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" alt="White Beach">
                <div class="package-info">
                    <h3>White Beach</h3>
                    <div class="package-duration">3D2N</div>
                    <ul class="activities-list" id="activities-white-beach">
                        <li>Snorkeling</li>
                        <li>Jet Skiing</li>
                        <li>Sunset Viewing</li>
                    </ul>
                    <button class="btn-book" onclick="openBookingForm('White Beach', ['Snorkeling','Jet Skiing','Sunset Viewing'], '3D2N')">Book Now</button>
                </div>
            </div>
            <!-- Sabang Beach Package -->
            <div class="package-card">
                <img class="package-image" src="https://images.unsplash.com/photo-1506744038136-46273834b3fb?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" alt="Sabang Beach">
                <div class="package-info">
                    <h3>Sabang Beach</h3>
                    <div class="package-duration">5D3N</div>
                    <ul class="activities-list" id="activities-sabang-beach">
                        <li>Scuba Diving</li>
                        <li>Underwater Photography</li>
                        <li>Nightlife</li>
                    </ul>
                    <button class="btn-book" onclick="openBookingForm('Sabang Beach', ['Scuba Diving','Underwater Photography','Nightlife'], '5D3N')">Book Now</button>
                </div>
            </div>
            <!-- Tamaraw Falls Package -->
            <div class="package-card">
                <img class="package-image" src="https://images.unsplash.com/photo-1507525428034-b723cf961d3e?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" alt="Tamaraw Falls">
                <div class="package-info">
                    <h3>Tamaraw Falls</h3>
                    <div class="package-duration">3D2N</div>
                    <ul class="activities-list" id="activities-tamaraw-falls">
                        <li>Swimming</li>
                        <li>Picnic</li>
                        <li>Sightseeing</li>
                    </ul>
                    <button class="btn-book" onclick="openBookingForm('Tamaraw Falls', ['Swimming','Picnic','Sightseeing'], '3D2N')">Book Now</button>
                </div>
            </div>
        </div>
    ...
    <div id="bookingModal" class="modal-overlay">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <div id="modalDuration" class="modal-duration" style="font-weight:bold; margin-bottom:0.5rem;"></div>
            ...
            <form id="bookingForm" class="modal-body" onsubmit="return false;">
                <div class="form-group">
                    ...
                    <select id="hotel" name="hotel" required>
                        ...
                        <option value="White Beach Resort">White Beach Resort</option>
                        <option value="Sabang Inn">Sabang Inn</option>
                        <option value="Tamaraw Beach Resort">Tamaraw Beach Resort</option>
                    </select>
                </div>
                <div class="form-group">
                ...
                <div class="summary-section">
                    <div class="summary-table">
                        <div class="summary-labels">
                            ...
                            <div id="transpoLabel">Transpo Price:</div>
                            <div>Hotel Price:</div>
                            <div>Sub Total:</div>
                            <div>Travel Tax:</div>
                            <div>VAT:</div>
                        ...
                        <div class="summary-values">
                            <div id="summaryPackagePrice"></div>
                            <div id="summaryHotelPrice"></div>
                            <div id="summaryTransportPrice"></div>
                            <div id="summaryGuests"></div>
                            <div id="summarySubtotal"></div>
                            <div id="summaryTravelTax"></div>
                            <div id="summaryVAT"></div>
                        </div>
                    </div>
                    <div class="total-row">
