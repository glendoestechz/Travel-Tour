...
<head>
    ...
    <title>Bulalacao Packages</title>
    <style>
        body {
...
<body>
    ...
    <main class="main-content">
        <div class="section-title">
            <h2>Bulalacao (Oriental Mindoro) Packages</h2>
            <p>Choose your adventure! Each package includes unique activities for an unforgettable experience.</p>
        </div>
        <div class="packages-grid">
            <!-- Suguicay Island Package -->
            <div class="package-card">
                <img class="package-image" src="https://images.unsplash.com/photo-1506744038136-46273834b3fb?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" alt="Suguicay Island">
                <div class="package-info">
                    <h3>Suguicay Island</h3>
                    ...
                    <button class="btn-book" onclick="openBookingForm('Suguicay Island', ['Snorkeling','Island Hopping','Kayaking'], '3D2N')">Book Now</button>
                </div>
            </div>
            <!-- Target Island Package -->
            <div class="package-card">
                <img class="package-image" src="https://images.unsplash.com/photo-1464983953574-0892a716854b?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" alt="Target Island">
                <div class="package-info">
                    <h3>Target Island</h3>
                    <div class="package-duration">3D2N</div>
                    <ul class="activities-list">
                    ...
                    <button class="btn-book" onclick="openBookingForm('Target Island', ['Swimming','Beach Camping','Sunset Viewing'], '3D2N')">Book Now</button>
                </div>
            </div>
            <!-- Tambaron Island Package -->
            <div class="package-card">
                <img class="package-image" src="https://images.unsplash.com/photo-1507525428034-b723cf961d3e?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" alt="Tambaron Island">
                <div class="package-info">
                    <h3>Tambaron Island</h3>
                    <div class="package-duration">3D2N</div>
                    <ul class="activities-list">
                        <li>Boating</li>
                        <li>Coral Viewing</li>
                    ...
                    <button class="btn-book" onclick="openBookingForm('Tambaron Island', ['Boating','Coral Viewing','Relaxation'], '3D2N')">Book Now</button>
                </div>
            </div>
        </div>
            ...
            <form id="bookingForm" class="modal-body" onsubmit="return false;">
                <div class="form-group">
                    ...
                    <select id="hotel" name="hotel" required>
                        ...
                        <option value="Suguicay Island Resort">Suguicay Island Resort</option>
                        <option value="Target Island Resort">Target Island Resort</option>
                        <option value="Tambaron Island Resort">Tambaron Island Resort</option>
                    </select>
                </div>
                <div class="form-group">
